...
getTematicas = function(){
  return ["Otro","Ocio", "Humanidades", "Tecnología"];
};
...
exports.index = function(req, res) {
  models.Quiz.findAll((req.query.search) ? {where: ["pregunta like ?", "%"+req.query.search+"%"]} : {}).then(
    function(quizes) {
      res.render('quizes/index', { quizes: quizes, busqueda : req.query.search ?  req.query.search  :"", errors : []});
    }
  ).catch(function(error) { next(error);})
};
